...
if (file.exists(rds)) {
  ...
  use_samples  <- intersect(rownames(meta), samples)
  ...
  gc()
  data <- SCTransform(data, conserve.memory = TRUE, verbose = FALSE)
  data <- RunPCA(data, verbose = FALSE)
  data <- RunUMAP(data, dims = 1:32, verbose = FALSE)
...
ElbowPlot(data, ndims = 50) + geom_vline(xintercept = 32)
